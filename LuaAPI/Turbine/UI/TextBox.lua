...
function TextBox:SetParent() 
end 
--- Sets the opacity of the window.  
--- (Inherited from Control) 
function TextBox:SetOpacity() 
end 
--- Sets the position of the control.  
--- (Inherited from Control) 
function TextBox:SetPosition() 
end 
--- Sets a flag indicating if the text in the label can be selected.  
--- (Inherited from Label) 
function TextBox:SetSelectable() 
end 
--- Sets a flag indicating if the text in the control is read only. 
function TextBox:SetReadOnly() 
end 
--- Replaces the selected text.  
--- (Inherited from Label) 
function TextBox:SetSelectedText() 
end 
--- Sets the text outline color.  
--- (Inherited from Label) 
function TextBox:SetOutlineColor() 
end 
--- Sets the selected text.  
--- (Inherited from Label) 
function TextBox:SetSelection() 
end 
--- Sets the position of the selection start.  
--- (Inherited from Label) 
function TextBox:SetSelectionStart() 
end 
--- Sets the length of the selected text.  
--- (Inherited from Label) 
function TextBox:SetSelectionLength() 
end 
--- Sets the size of the control.  
--- (Inherited from Control) 
function TextBox:SetSize() 
end 
--- Sets the visible flag of a control.  
--- (Inherited from Control) 
function TextBox:SetVisible() 
end 
--- Sets the top coordinate of the window.  
--- (Inherited from Control) 
function TextBox:SetTop() 
end 
...
--- (Inherited from Control) 
function TextBox:SetWantsUpdates() 
end 
--- Gets a flag indicating if the control is enabled.  
--- (Inherited from Control) 
function TextBox:IsEnabled() 
end 
--- Sets the Z order of the control.  
--- (Inherited from Control) 
function TextBox:SetZOrder() 
end 
...
--- (Inherited from Label) 
function TextBox:GetOutlineColor() 
end 
--- Gets the mouse position relative to this control.  
--- (Inherited from Control) 
function TextBox:GetMousePosition() 
end 
--- Gets the horizontal scroll bar.  
--- (Inherited from ScrollableControl) 
function TextBox:GetHorizontalScrollBar() 
end 
--- Gets the foreground color.  
--- (Inherited from Label) 
function TextBox:GetForeColor() 
end 
--- Gets the blend mode applied to the background image.  
--- (Inherited from Control) 
function TextBox:GetBlendMode() 
end 
--- Gets the background graphic of the control.  
--- (Inherited from Control) 
function TextBox:GetBackground() 
end 
--- Gets the font style.  
--- (Inherited from Label) 
function TextBox:GetFontStyle() 
end 
...
--- (Inherited from Label) 
function TextBox:GetSelectionStart() 
end 
...
--- (Inherited from Control) 
function TextBox:SetBackColor() 
end 
--- Test if the shift key is pressed.  
--- (Inherited from Control) 
function TextBox:IsShiftKeyDown() 
end 
--- Converts a coordinate from control space to screen space.  
--- (Inherited from Control) 
function TextBox:PointToScreen() 
end 
--- Converts a coordinate from control space to screen space.  
--- (Inherited from Control) 
function TextBox:PointToClient() 
end 
...
--- (Inherited from Control) 
function TextBox:SetHeight() 
end 
--- Sets the foreground color.  
--- (Inherited from Label) 
function TextBox:SetForeColor() 
end 
--- Sets a flag indicating if the control is enabled.  
--- (Inherited from Control) 
function TextBox:SetEnabled() 
end 
--- Sets the horizontal scroll bar.  
--- (Inherited from ScrollableControl) 
function TextBox:SetHorizontalScrollBar() 
end 
--- Sets the left coordinate of the window.  
--- (Inherited from Control) 
function TextBox:SetLeft() 
end 
--- Gets a flag indicating if the mouse will see this control.  
--- (Inherited from Control) 
function TextBox:SetMouseVisible() 
end 
--- Event fired when the mouse moves.  
--- (Inherited from Control) 
function TextBox:MouseMove() 
end 
...
--- (Inherited from Control) 
function TextBox:MouseHover() 
end 
--- Event fired when the visible state of the control changes.  
--- (Inherited from Control) 
function TextBox:VisibleChanged() 
end 
...
--- (Inherited from Control) 
function TextBox:EnabledChanged() 
end 
--- Event fired when the enabled state of the control changes. 
function TextBox:EnabledChanged() 
end 
