...
function Button:GetLeft() 
end 
--- Gets the mouse position relative to this control.  
--- (Inherited from Control) 
function Button:GetMousePosition() 
end 
--- Gets the opacity of the window.  
--- (Inherited from Control) 
function Button:GetOpacity() 
end 
...
--- (Inherited from Label) 
function Button:GetSelectionLength() 
end 
--- Gets the position of the selection start.  
--- (Inherited from Label) 
function Button:GetSelectionStart() 
end 
...
--- (Inherited from Control) 
function Button:GetZOrder() 
end 
--- Appends text to the end of the label.  
--- (Inherited from Label) 
function Button:AppendText() 
end 
...
--- Sets the font style.  
--- (Inherited from Label) 
function Button:SetFontStyle() 
end 
--- Sets the foreground color.  
--- (Inherited from Label) 
function Button:SetForeColor() 
end 
--- Deselects all the text in the control.  
--- (Inherited from Label) 
function Button:DeselectAll() 
end 
--- Sets the height of the control.  
--- (Inherited from Control) 
function Button:SetHeight() 
end 
--- Sets the horizontal scroll bar.  
--- (Inherited from ScrollableControl) 
function Button:SetHorizontalScrollBar() 
end 
--- Sets the left coordinate of the window.  
--- (Inherited from Control) 
function Button:SetLeft() 
end 
--- Sets a flag indicating if markup is enabled for the label.  
--- (Inherited from Label) 
function Button:SetMarkupEnabled() 
end 
--- Gets a flag indicating if the mouse will see this control.  
--- (Inherited from Control) 
function Button:SetMouseVisible() 
end 
--- Sets if the label should display on multiple lines.  
--- (Inherited from Label) 
function Button:SetMultiline() 
end 
--- Gets if the control supports drop operations from drag and drop.  
--- (Inherited from Control) 
function Button:GetAllowDrop() 
end 
--- Sets the opacity of the window.  
--- (Inherited from Control) 
function Button:SetOpacity() 
end 
--- Sets the text outline color.  
--- (Inherited from Label) 
function Button:SetOutlineColor() 
end 
...
--- (Inherited from Control) 
function Button:SetPosition() 
end 
--- Sets a flag indicating if the text in the label can be selected.  
--- (Inherited from Label) 
function Button:SetSelectable() 
end 
--- Replaces the selected text.  
--- (Inherited from Label) 
function Button:SetSelectedText() 
end 
--- Sets the selected text.  
--- (Inherited from Label) 
function Button:SetSelection() 
end 
--- Sets the length of the selected text.  
--- (Inherited from Label) 
function Button:SetSelectionLength() 
end 
--- Sets the position of the selection start.  
--- (Inherited from Label) 
function Button:SetSelectionStart() 
end 
...
--- (Inherited from Label) 
function Button:SetTextAlignment() 
end 
--- Sets the top coordinate of the window.  
--- (Inherited from Control) 
function Button:SetTop() 
end 
--- Sets the vertical scroll bar.  
--- (Inherited from ScrollableControl) 
function Button:SetVerticalScrollBar() 
end 
...
--- (Inherited from Control) 
function Button:SetWantsKeyEvents() 
end 
--- Sets the flag indicating if the cotnrol wants to receive update notifications.  
--- (Inherited from Control) 
function Button:SetWantsUpdates() 
end 
--- Sets the width of the control.  
--- (Inherited from Control) 
function Button:SetWidth() 
end 
--- Sets the Z order of the control.  
--- (Inherited from Control) 
function Button:SetZOrder() 
end 
...
--- (Inherited from ScrollableControl) 
function Button:GetHorizontalScrollBar() 
end 
--- Gets the solid background color of the control.  
--- (Inherited from Control) 
function Button:GetBackColor() 
end 
--- Gets the blend mode applied to the background color.  
--- (Inherited from Control) 
function Button:GetBackColorBlendMode() 
end 
...
--- (Inherited from Control) 
function Button:GetBlendMode() 
end 
--- Gets the foreground color.  
--- (Inherited from Label) 
function Button:GetForeColor() 
end 
...
--- (Inherited from Control) 
function Button:FocusGained() 
end 
--- Event fired when the control loses focus.  
--- (Inherited from Control) 
function Button:FocusLost() 
end 
--- Event fired when a key is pressed down.  
--- (Inherited from Control) 
function Button:KeyDown() 
end 
--- Event fired when a key is released.  
--- (Inherited from Control) 
function Button:KeyUp() 
end 
...
--- (Inherited from Control) 
function Button:MouseDoubleClick() 
end 
